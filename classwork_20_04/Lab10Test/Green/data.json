{
  ...
  "Task3": {
    ...
    "output": [
      [ "После", "основной", "деятельность", "последние", "рост", "достиг", "способствующими", "последствиям" ],
      [ "Двигатель", "движение", "двигателя" ],
      [],
      [ "Фьорды", "фьордс", "фьордар" ],
      [ "William" ],
      [ "Первое", "Фернаном", "примерно", "первой" ]
    ]
  },
  ...
  "Task4": {
    ...
    "output": [
      [ "Волков", "Иванов", "Иванова", "Козлов", "Кузнецов", "Лебедев", "Новиков", "Петров", "Петрова", "Попов", "Смирнов", "Смирнова", "Соколов" ],
      [ "Ivanov", "Ivanova", "Kozlov", "Kuznetsov", "Lebedev", "Novikov", "Petrov", "Petrova", "Popov", "Smirnov", "Smirnova", "Sokolov", "Volkov" ]
    ]
  }
}